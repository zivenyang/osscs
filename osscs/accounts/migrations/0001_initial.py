# Generated by Django 4.0.2 on 2022-03-14 08:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(default='小可爱', max_length=32, verbose_name='昵称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.SmallIntegerField(choices=[(1, 'github_api'), (0, 'libraries_io_api')], verbose_name='api_key类型')),
                ('token', models.CharField(max_length=256, verbose_name='密钥')),
